...
namespace BusinessManagement
{
    public partial class CustomerPaymentReport : Form
    {
        ...
        private void CustomerPaymentReport_Load(object sender, EventArgs e)
        {
            ...
            cboVendor.DataSource = customers;
            cboVendor.DisplayMember = "Name";
            cboVendor.ValueMember = "CustomerId";
        ...
        private void BtnView_Click(object sender, EventArgs e)
        {
            ...
            {
                int customerid = Convert.ToInt32(cboVendor.SelectedValue.ToString());
                var lst = _db.tblCustomerPayments.Where(v => v.CustomerId == customerid && v.PaymentDate >= dateTimePicker1.Value && v.PaymentDate <= dateTimePicker2.Value).Select(x => new { PaymentDate = x.PaymentDate, TotalAmount = x.TotalAmount, PaymentAmount = x.PaymentAmount, RemainingAmount = x.RemainingAmount }).ToList();
