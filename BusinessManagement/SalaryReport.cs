    ...
    public partial class SalaryReport : Form
    {
        ...
        private void CboEmployee_SelectedIndexChanged(object sender, EventArgs e)
        {
            if(cboEmployee.SelectedIndex!=0)
            {
                ...
                dataGridView1.DataSource = _db.tblEmployeePayments.Where(p => p.EmployeeId == employeeid).Select(x => new { PaymentDate = x.PaymentDate, Amount = x.Amount, PaymentBy = x.PaymentBy }).ToList();
            }
        }
