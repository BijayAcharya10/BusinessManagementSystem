    ...
    public partial class StockReport : Form
    {
        ...
        private void CboCategory_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboCategory.SelectedIndex != 0)
            {
             ...
             dataGridView1.DataSource=   db.tblStocks.Where(u => u.tblProduct.CategoryId == categoryid).Select(x=>new {ProductName=x.tblProduct.ProductName, Quantity=x.Quantity}).ToList();
            }
